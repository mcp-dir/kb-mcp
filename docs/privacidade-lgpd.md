...
Base de Conhecimento segue a LGPD (Lei nº 13.709/2018).
...
|---|---|---|
| **OpenAI** | US | embeddings + OCR (visão) |
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [kb@mcp.ai](mailto:kb@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
